...
export default class Logs{
    ...
    public info(...message: any[]): void{
        ...
        console.log(`${Chalk.blueBright('[INFO]')} ${this.logDate()} ${this.logTime()}`, ...message);
    }

    public success(...message: any[]): void{
        this.setLogType(ELogType.SUCCESS);
        console.log(`${Chalk.greenBright('[SUCCESS]')} ${this.logDate()} ${this.logTime()}`, ...message);
    }

    public warning(...message: any[]): void{
        this.setLogType(ELogType.WARNING);
        console.log(`${Chalk.yellowBright('[WARNING]')} ${this.logDate()} ${this.logTime()}`, ...message);
    }

    public error(...message: any[]): void{
        this.setLogType(ELogType.ERROR);
        console.log(`${Chalk.redBright('[ERROR]')} ${this.logDate()} ${this.logTime()}`, ...message);
    }

    public debug(...message: any[]): void{
        this.setLogType(ELogType.DEBUG);
        console.log(`${Chalk.magentaBright('[DEBUG]')} ${this.logDate()} ${this.logTime()}`, ...message);
    }
    ...
    public custom(message: string, ...styles: string[]): void{
        ...
        console.log(`${style(`[${this.getLogType().toUpperCase()}]`)} ${this.logDate()} ${this.logTime()}`, message);
    }
